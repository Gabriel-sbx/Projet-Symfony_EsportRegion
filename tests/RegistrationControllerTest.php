...
class RegistrationControllerTest extends WebTestCase
{
    ...
    public function testRegister(): void
    {
        ...
        $this->client->submitForm('Enregistrer', [
            ...
            'registration_form[name]' => 'password',
            'registration_form[surname]' => 'password',
            'registration_form[pseudo]' => 'password',
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'gabriel.soubeyroux@outlook.com');
        self::assertEmailAddressContains($messages[0], 'to', 'me@example.com');
        // test plus souple pour éviter les probleme de localité ou il pourrais attendre un message en anglais 
        self::assertEmailTextBodyContains($messages[0], 'expir');
